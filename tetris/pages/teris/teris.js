Page({
  ...
  onReady: function () {
    ...
    //图形生成
    this.cur = Math.floor(Math.random() * 7 + 1);
    //this.cur = 7;
    this.next = 0;
    this.degree = 0;
  ...
  initGame: function () {
    ...
    this.initBoard();
    this.initShape();
    this.interval = setInterval(this.downShape, 1000);
  },
  initBoard: function () {
    this.board = [];
  ...
  initShape: function (flag) {

    this.degree = 0;
    this.createShape(this.cur);
    var next = Math.floor(Math.random() * 7 + 1);
    this.createNextShape(next);
    this.next = next;
  ...
  createShape: function (shapeType) {
    ...
    //图形渲染
    this.drawShape(shapeType, postion);

    this.postion = this.copy(postion);
  },
  drawShape: function (shapeType, postion) {
  ...
  clearShape: function (postion) {
    ...
    context.clearRect(postion.one.x * 20, postion.one.y * 20, 20, 20);
    context.clearRect(postion.two.x * 20, postion.two.y * 20, 20, 20);
    context.clearRect(postion.three.x * 20, postion.three.y * 20, 20, 20);
    context.clearRect(postion.four.x * 20, postion.four.y * 20, 20, 20);
  ...
  drawShape2: function (shapeType, postion) {
    this.board[postion.one.y][postion.one.x] = shapeType;
    this.board[postion.two.y][postion.two.x] = shapeType;
    this.board[postion.three.y][postion.three.x] = shapeType;
    this.board[postion.four.y][postion.four.x] = shapeType;
    ...
    context.rect(postion.one.x * 20, postion.one.y * 20, 20, 20);
    context.rect(postion.two.x * 20, postion.two.y * 20, 20, 20);
    context.rect(postion.three.x * 20, postion.three.y * 20, 20, 20);
    context.rect(postion.four.x * 20, postion.four.y * 20, 20, 20);
  ...
  createNextShape: function (shapeType) {
    //创建下一个图形位置
    var postion = {
      one: {
        x: 0, y: 0
  ...
  downShape: function () {
    ...
    //4、绘图
    this.drawShape(this.cur, postion);
